 ...
 *
 * $Id: DataTableContentProvider.java,v 1.1 2005/04/05 02:45:26 mojo_jojo Exp $
 */
...
public class DataTableContentProvider implements IStructuredContentProvider {
    ...
    /**
     * Disposes of this AttributesTableContentProvider For now nothing to be
     * done here.
     * 
    ...
    /**
     * Called by jface/swt if a change of input occures. For now nothing to be
     * done : we don't listen to any change of the inputs yet.
     * 
     ...
     * 
     * @param treeElement
     *            the currently selected tree element as an object.
