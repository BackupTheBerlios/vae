 ...
 *
 * $Id: SimpleProject.java,v 1.1 2004/09/05 00:30:22 mojo_jojo Exp $
 */
 ...
 * @author mojo_jojo
 *
 * Simple and rought implementation of the Project interface.
 * ought to be improved in the future.
 * This one is used by the Sax parser.
 * When more than one implementation of org.vae.core.Project
 * will be available, the parser will have to use a 
 * ProjectFactory.
 */
public class SimpleProject extends Project {
	 ...
	 */
	private static String[] legalAttributes = {"name", "default", 
			"basedir"};
	
	/**
	 * Base directory of the ant project.
	 * According to the ant specifications, the base
	 ...
	 * According to ant specifications, a project 
	 * has to have at least one default target.
	 */
	private String defaultTarget;

	/**
	 * Description of the ant project.
	 * According to the ant specifications, a description
	 * is optional.
	 */
	...
	/**
	 * Creates a SimpleProject from a parsed Tag.
	 * Will be used some time soon to keep the parser very generic. 
	 * @param projectTag
	 */
	 ...
	 * If the taskdef doesn't have a name, it receives a generic name
	 * TaskDefX, where X is a number incremented each time a new taskDef
	 * is defined.
	 * @param the taskDef to be added to the project.
	 */
	 ...
	 * This tags are basically at the level of targets, but are neigher properties nor
	 * targets. At one point this elements need to be integrated specifically, but we
	 * want at least to display them in the tree with a specific image.
	 * @param unidentifiedTag the unidentified Tag to be added.
	 */
	...
	/**
	 * Gets the description associated to the current 
	 * project
	 ...
	 * @return a java.util.HashMap containing the taskdefs of the project.
	...
	/**
	 * Keeps the internal data in sync to reflect the removal of an 
	 * attribute.
	 * @param attributeName name of the attribute that is being removed.
	...
	* Calls the adequate removal methods to keep the internal data in sync.
	...
	*/
	 ...
	 * TODO Implement RemoveProperty in SimpleProject. 
	 ...
	 * TODO implement RemoveTarget  in SimpleProject.
	 ...
	 * @param taskDefName the name of the TaskDef
	 * @throws NoSuchTaskDefException if the TaskDef does not exist.
	 * TODO implement TaskDef in SimpleProject.
	 * @see org.vae.core.Project#RemoveTaskDef(java.lang.String)
	 */
	public void removeTaskDef(String taskDefName) 
	 ...
	 * @param tagName the name of the unidentified tag.
	 ...
	 */
	public void removeUnidentifiedTag(String tagName) 
	throws NoSuchTagException
	{
		System.out.println("! Not Implement Yet !");
	}
	 ...
	 * @param the base directory of the project.
	 */
	 ...
	 * @param the name of the default task.
	 */
	 ...
	 * @param the description of project.
	 */
	...
	/**
	 * @param the properties of the ant project.
	 */
	 ...
	 * @param the targets of the ant project.
	 */
	 ...
	 * @param the taskDefs in a HashMap.
	 */
	 ...
	 * @param the unidentified tags in a List.
	...
	/**
	 * Verifies if an attribute is valid and calls the adequate methods
	 * when they are.
	 * @param attributeName name of the attribute.
	 * @param attributeValue value of the attribute.
	 * @throws IllegalAttributeException if the attribute is not legal.
	 */
	protected void verifyAttribute(String attributeName, 
	...
	throws IllegalAttributeException
	{
		if(attributeName.equalsIgnoreCase("name")) {
			...
			throw new  IllegalAttributeException(
					attributeName, name.toString(), legalAttributes);
		}
	}
	
	/**
	 * Sync the local data with the build data. 
	 * In this implementation it lets everything go through and we call
	 * the relevant functions according to the tag type.
