 ...
 *
 * $Id: DataTableContentProvider.java,v 1.1 2004/09/02 22:48:04 mojo_jojo Exp $
 */
...
public class DataTableContentProvider implements IStructuredContentProvider {
	...
	{
		if(treeElement instanceof SwtElement) {
			return ((SwtElement)treeElement).getAttributes();
		} else {
