 ...
 *
 * $Id: Project.java,v 1.1 2004/08/17 22:37:12 mojo_jojo Exp $
 */
package org.va_labs.vae.core.definitions;

import java.util.List;

import org.va_labs.vae.exceptions.NoSuchPropertyException;
import org.va_labs.vae.exceptions.NoSuchTagException;
import org.va_labs.vae.exceptions.NoSuchTargetException;
import org.va_labs.vae.exceptions.NoSuchTaskDefException;

/**
 * @author mojo_jojo
 * abstract class that defines the different methods that a 
 * project should support.
 */
public abstract class Project extends Tag {
    /**
	 * Default constructor of project object.
	 * Simply calls the constructor of Tag.
	 ...
	 * @param the list of "unidentified tags" for this project
	 * @see #setUnidentifiedTags(List) for more details about what "unidentified tags" mean.
	 */
	 ...
	 * @param propertyName
	 * @throws NoSuchPropertyException if the property does not aooear in
	 * the list.
	 */
	 ...
	 * @throws NoSuchTargetException if the target does not appear in the
	 * list.
	 */
	 ...
	 * @throws NoSuchTaskDefException if the taskDef does not appear in
	 * the list.
	 */
	 ...
	 * @param tagName name of the UnidentifiedTag.
	 * @throws NoSuchTagException if the tag does not appear in the list.
	 */
	 ...
	 * @param the name of the default target.
	 */
	 ...
	 * targets. At one point this elements need to be integrated specifically, but we
	 * want at least to display them in the tree with a specific image.
	 * @param a list of unidentied tags
	 */
